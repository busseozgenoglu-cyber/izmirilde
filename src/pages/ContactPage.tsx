...
const districts = [
  'Alsancak / Kordon', 'Karşıyaka', 'Bornova', 'Buca', 'Konak / Kemeraltı',
  'Çeşme', 'Alaçatı', 'Urla', 'Foça', 'Seferihisar / Sığacık',
  'Dikili', 'Bergama', 'Selçuk', 'Ödemiş', 'Tire',
  'Balçova', 'Narlıdere', 'Gaziemir', 'Bayraklı', 'Çiğli',
  'Karabağlar', 'Menemen', 'Kemalpaşa', 'Güzelbahçe', 'Menderes',
  'Karaburun', 'Kınık', 'Aliğa', 'Torbalı', 'Kiraz',
  'Beydağ', 'Diğer',
]

const categories = ['Kahvaltı', 'Restoran', 'Bar', 'Beach', 'Kültür & Sanat', 'Diğer']
...
export default function ContactPage() {
  ...
  const isVenue = form.subject === 'Mekan Ekle'
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Form + Info */}
        <section className="bg-white py-16 lg:py-20" id="contact-form">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] gap-12">
              ...
              <div className="reveal">
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3.5 border border-black/12 rounded-lg text-base focus:border-black transition-colors"
                          placeholder="Örn: Alsancak, Kıbrıs Şehitleri Cd. No:12"
                        />
                      </div>
                      <div>
                        <label className="block text-[13px] font-medium text-black/50 mb-1.5">
                  ...
                  <div>
                    <label className="block text-[13px] font-medium text-black/50 mb-1.5">
                      {isVenue ? 'Mekan Hakkında' : 'Mesajınız'}
                    </label>
                    <textarea
                      value={form.message}
                      ...
                      placeholder={
                        isVenue
                          ? 'Mekanınızı kısaca tanıtın. Ne yemekleri var? Ortam nasıl? Neden listelenmeli?'
                          : 'Mesajınızı yazın...'
                      }
                      required
                    />
